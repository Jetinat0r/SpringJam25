        ...
        CGPROGRAM
            ...
            fixed4 frag(v2f IN) : SV_Target
            {
                ...
                if (_usePalette)
                {
                    ...
                    color = SwapPalette(color, _paletteImage, sampler_paletteImage, _paletteImageTexelSize, _curPaletteIndex, _nextPaletteIndex, _paletteCondenseAmount, _paletteMixAmount);
                }
